...
import ellipseCheckmark from '../../../public/assets/images/ellipseCheckmark.png';
    ...
    <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg w-full max-w-7xl flex items-center justify-center mx-auto">
      <div className="flex flex-col items-center w-full max-w-xl">
        <div className="w-full flex flex-col items-center px-4 sm:px-0 py-8 sm:py-12">
          ...
          <img src={ellipseCheckmark} alt="" className="absolute w-[100px] sm:w-[120px] md:w-[136px] h-[100px] sm:h-[120px] md:h-[136px] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" />
          </div>
          <h2 className="text-[24px] sm:text-[27px] md:text-[30px] leading-[30px] sm:leading-[34px] md:leading-[38px] font-semibold text-black mt-[30px] sm:mt-[35px] md:mt-[40px] text-center">Test submitted</h2>
