...
const WritingPart3 = ({ content, subContent, questions, partId }) => {
  return (
    <div className="w-full">
     
      <div className="w-full bg-[#FFFFFF] rounded-lg p-6 min-h-[1269px]" style={{ border: '0.5px solid rgba(0, 0, 0, 0.3)' }}>
