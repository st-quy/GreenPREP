...
import { useWritingPart2 } from '../hooks/useWritingPart2';
...
const WritingPart2 = () => {
  const { data, isLoading, error } = useWritingPart2();
  const dispatch = useDispatch();

  useEffect(() => {
    // Set initial time to 7 minutes (420 seconds)
    dispatch(setTime(420));
  }, [dispatch]);
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="w-full bg-[#FFFFFF] rounded-lg p-6 h-[714px] overflow-y-auto" style={{ border: '0.5px solid rgba(0, 0, 0, 0.3)' }}>
          <div className="flex justify-between items-center mb-4">
            <h2><span className="text-[#3758F9]">Part 2</span> of 4</h2>
