      ...
      <Content className="w-full ">
        ...
        >
          <Flex gap={10} vertical>
            <Text className="text-lg/[26px] font-bold text-[#003087]">
              Test Structure & Flow
            </Text>
            ...
            {StepData.map((item, index) => (
              <Flex className="gap-3 sm:gap-3 md:gap-4 lg:gap-5" key={index}>
                <Flex
                  justify="center"
                  align="center"
                  className="w-full max-w-10 h-10 md:max-w-10 md:h-10 lg:max-w-14 lg:h-14 rounded-full text-lg md:text-xl lg:text-[28px]/[16px] font-medium border border-solid border-[#003087] text-[#003087] hover:bg-[#003087] hover:text-white"
                >
                  {index + 1}
                </Flex>
          ...
          <Button
            type="primary"
            size="middle"
            className="text-1/4 md:text-1/5 lg:w-1/6 rounded-full !text-md mx-auto my-10 h-max-fit h-[48px] bg-[#003087] hover:bg-[#002A6B] border-hidden"
            htmlType="button"
